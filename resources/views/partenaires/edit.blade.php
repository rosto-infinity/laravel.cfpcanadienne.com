        ...
        <form action="{{ route('partenaires.update', $partenaire) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <label for="logo" class="cursor-pointer flex-1">
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl p-6 text-center hover:border-[#7917f9] dark:hover:border-[#7917f9] transition-colors">
                            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                            </svg>
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-semibold text-[#7917f9] dark:text-[#7917f9]">Cliquez pour uploader</span> ou glissez-déposez
                            </p>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" placeholder="Décrivez votre entreprise et votre activité..."
                    class="w-full rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-gray-900 dark:text-white focus:border-[#7917f9] focus:ring-4 focus:ring-[#7917f9]/20 transition-all resize-none">{{ old('description', $partenaire->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex gap-4 pt-4">
                ...
                <button type="submit" 
                    class="flex-1 bg-gradient-to-r from-[#7917f9] to-[#7917f9] hover:from-[#7917f9] hover:to-[#7917f9] text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    Mettre à jour
                </button>
            </div>
        </form>
